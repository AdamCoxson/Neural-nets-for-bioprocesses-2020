...
for i in range(0,combinations):
    ...
    hyperparam_list.append([hn[0], hn[1], epochs, lr, bs])
...
if do_parallel == True:
    ...
    avg_mse_data[:] = Parallel(n_jobs=2)(delayed(neural_net)(cfg) for cfg in hyperparam_list)
else: 
    i = 0    
...
write_to_csv(filename, avg_mse_data, hyperparam_list, ["H1","H2","Epochs", "Learing rate", "Batch size"], fin_time-init_time)
